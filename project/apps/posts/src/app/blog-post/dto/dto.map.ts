...
export type BlogPostDtoGeneric<T extends PostTypeEnum, Author = {authorId: string}> = T extends keyof BlogPostDtoMap ? InstanceType<ClassConstructor<BlogPostDtoMap[T] & Author>> : never;
